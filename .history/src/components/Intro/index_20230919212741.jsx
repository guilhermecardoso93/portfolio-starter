      ...
      <div className="intro-left">
        ...
        <div className="intro-icons">
          <a href="/" target="_blank">
            <FontAwesomeIcon icon={faGithub} style={{ color: "#070bf0" }} size='xl'/>
          </a>
          <a href="/" target="_blank">
            <FontAwesomeIcon icon={faInstagram} style={{ color: "#070bf0" }} size='xl'/>
          </a>
          <a href="/" target="_blank">
            <FontAwesomeIcon icon={faLinkedin} style={{ color: "#070bf0" }} size='xl'/>
          </a>
        </div>
      </div>
